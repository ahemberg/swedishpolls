...
class PollObservationsTest {
  ...
  void modelValuesDoNotExposeTheirMatrixForMutation() {
    ...
    final se.swedishpolls.estimation.ModelValues values = ModelValues.copyOf(source);
  ...
  void replacesOnlyExactZerosAndPreservesPositiveRatiosAndSourceValues() {
    ...
    final se.swedishpolls.estimation.PollObservations.Batch capped =
  ...
  void handlesZeroRemaindersWithoutClippingSmallPositiveSharesAndFollowsDeclaredOrder() {
    ...
    final se.swedishpolls.estimation.PollObservations.Batch small =
        PollObservations.prepare(
            period(false),
    ...
    final se.swedishpolls.source.Roster.CoveragePeriod reverse =
        new Roster.CoveragePeriod(
            ...
            true,
            "https://example.invalid");
    final se.swedishpolls.estimation.PollObservations.Batch reordered =
  ...
  private static void checkGeometryAndDenseCovariance(
    ...
    final se.swedishpolls.estimation.ModelValues h = batch.basis();
    ...
    final se.swedishpolls.estimation.ModelValues actual =
        batch.observations().getFirst().covariance();
  ...
  void convertsBothRostersAtTheMidpointWithReferenceIlrAndFullCovariance() {
    ...
    for (boolean fi : List.of(false, true)) {
      ...
      final se.swedishpolls.estimation.ModelValues covariance = observation.covariance();
