...
public final class SiteText {
  ...
  private static Map<String, String> swedish() {
    ...
    text.put("polls.loading", "Hämtar mätningar.");
    text.put("polls.failed", "Mätningarna kunde inte hämtas. Försök igen.");
    text.put(
        "polls.tableCaption",
  ...
  private static Map<String, String> english() {
    ...
    text.put("polls.loading", "Loading polls.");
    text.put("polls.failed", "The polls could not be loaded. Try again.");
    text.put(
        "polls.tableCaption",
