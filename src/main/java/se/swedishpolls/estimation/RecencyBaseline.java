...
public final class RecencyBaseline {
  ...
  public static Fit fit(PollObservations.Batch training, LocalDate asOf) {
    final java.util.List<se.swedishpolls.estimation.PollObservations.Observation> ordered =
    ...
    final java.util.List<se.swedishpolls.estimation.PollObservations.Observation> recent =
        ordered.stream()
            .filter(
