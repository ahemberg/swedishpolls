...
public final class DevelopmentTuning {
  ...
  public record Grid(
    ...
    public List<DailyStateSpace.Parameters> points() {
      final java.util.ArrayList<se.swedishpolls.estimation.DailyStateSpace.Parameters> points =
  ...
  public static Protocol protocol(Path file) {
    try {
      ...
      final java.util.ArrayList<se.swedishpolls.estimation.DevelopmentTuning.Fold> folds =
          new ArrayList<Fold>();
  ...
  public static Tuning tuneAll(
      ...
      List<LocalDate> elections,
      Protocol protocol) {
    final java.util.ArrayList<se.swedishpolls.estimation.DevelopmentTuning.Resolved> resolved =
        new ArrayList<Resolved>();
    final java.util.ArrayList<se.swedishpolls.estimation.DevelopmentTuning.Unresolved> unresolved =
  ...
  public static Map<String, DailyStateSpace.Parameters> latestParameters(Tuning tuning) {
    ...
    for (se.swedishpolls.estimation.DevelopmentTuning.Resolved resolved : tuning.resolved())
      latest.merge(
          resolved.periodId(),
          resolved,
          (kept, candidate) ->
