...
headline probability more than 10 percentage points, and no such field when none does. It
is a disclosure beside the numbers, never a block on publication.
